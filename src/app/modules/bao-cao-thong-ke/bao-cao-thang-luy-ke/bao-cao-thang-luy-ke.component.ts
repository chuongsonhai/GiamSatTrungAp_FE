...
@Component({
  selector: 'app-bao-cao-thang-luy-ke',
  templateUrl: './bao-cao-thang-luy-ke.component.html',
  styleUrls: ['./bao-cao-thang-luy-ke.component.scss'],
  providers: [
...
export class BaoCaoThangLuyKeComponent implements
OnInit,
OnDestroy,
IDeleteAction,
IDeleteSelectedAction,
...
getbaocao() {
  ...
  const subscribe = this.service.getBaoCaoChiTietLuyKe(filter).pipe(
    catchError(err => {
      return of(undefined);
    })).subscribe(res => {
      debugger;
...
exportExcel() {
  ...
  this.service.exportExcelLuyKe(filter).subscribe((response) => {
    if(response === undefined || response === null){
      ...
      link.download="Báo cáo chi tiết luỹ kế.xlsx";
      link.click();
