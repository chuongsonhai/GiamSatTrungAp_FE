...
import { BaoCaoYCNTService } from '../../services/baocaoycnt.service';
import { CommonService } from '../../services/common.service';
import { Organization } from '../../models/organization.model';
@Component({
  selector: 'app-tien-do-nghiem-thu',
  templateUrl: './tien-do-nghiem-thu.component.html',
  styleUrls: ['./tien-do-nghiem-thu.component.scss'],
  providers: [
...
export class TienDoNghiemThuComponent implements
OnInit,
OnDestroy,
IDeleteAction,
IDeleteSelectedAction,
...
constructor(
  ...
  public service: BaoCaoYCNTService,
...
exportExcel() {
  ...
  this.service.exportExcel(filter).subscribe((response) => {
    if(response === undefined || response === null){
      ...
      link.download="Báo cáo chi tiết KTDKDDN và nghiệm thu.xlsx";
      link.click();
