...
@Component({
  selector: 'app-tong-hop-tcdn',
  templateUrl: './tong-hop-tcdn.component.html',
  styleUrls: ['./tong-hop-tcdn.component.scss'],
  providers: [
...
export class TongHopTcdnComponent  implements
OnInit,
OnDestroy {
isLoading: boolean;
...
exportExcel() {
  ...
  this.service.exportExcelTHTCDN(filter).subscribe((response) => {
    if(response === undefined || response === null){
      ...
      link.download="Báo cáo tổng hợp TCDN.xlsx";
      link.click();
