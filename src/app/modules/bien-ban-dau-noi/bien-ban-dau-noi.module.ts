...
import { BienBanDauNoiRoutingModule } from './bien-ban-dau-noi-routing.model';
@NgModule({
    declarations: [
        BienBanDauNoiComponent,
        ListBienBanDNComponent
    ],
    imports: [
        BienBanDauNoiRoutingModule,
...
export class BienBanDauNoiModule {
