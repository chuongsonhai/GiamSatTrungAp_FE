...
import { BienBanDNService } from '../../services/bienbandn.service';
import { BienBanDN } from '../../models/bienbandn.model';
...
@Component({
  selector: 'app-list-bien-ban-dau-noi',
  templateUrl: './list-bien-ban-dau-noi.component.html',
  styleUrls: ['./list-bien-ban-dau-noi.component.scss'],
  providers: [
...
export class ListBienBanDNComponent implements
  OnInit,
  OnDestroy,
  IDeleteAction,
  IDeleteSelectedAction,
