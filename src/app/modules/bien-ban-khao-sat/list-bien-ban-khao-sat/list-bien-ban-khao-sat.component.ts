...
import { BienBanKS, Organization } from '../../models/base.model';
...
@Component({
  selector: 'app-list-bien-ban-khao-sat',
  templateUrl: './list-bien-ban-khao-sat.component.html',
  styleUrls: ['./list-bien-ban-khao-sat.component.scss'],
  providers: [
...
export class ListBienBanKSComponent implements
  OnInit,
  OnDestroy,
  IDeleteAction,
  IDeleteSelectedAction,
