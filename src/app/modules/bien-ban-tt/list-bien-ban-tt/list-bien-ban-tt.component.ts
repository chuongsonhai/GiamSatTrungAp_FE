...
import { BienBanTTService } from '../../services/bienbantt.service';
...
@Component({
  selector: 'app-list-bien-ban-tt',
  templateUrl: './list-bien-ban-tt.component.html',
  styleUrls: ['./list-bien-ban-tt.component.scss'],
  providers: [
...
export class ListBienBanTTComponent implements 
