...
import { UpdateCauHinhMauComponent } from './components/update-cau-hinh-mau.component';
import { ToastrService } from 'ngx-toastr';
import { ConfirmationDialogService } from '../../share-component/confirmation-dialog/confirmation-dialog.service';

@Component({
  selector: 'app-cau-hinh-mau',
  templateUrl: './cau-hinh-mau.component.html',
  styleUrls: ['./cau-hinh-mau.component.scss'],
  providers: [
...
export class CauHinhMauComponent implements OnInit, OnDestroy,
  ...
  // actions
  update(id: string) {
    const modalRef = this.modalService.open(UpdateCauHinhMauComponent, { size: 'lg' });
