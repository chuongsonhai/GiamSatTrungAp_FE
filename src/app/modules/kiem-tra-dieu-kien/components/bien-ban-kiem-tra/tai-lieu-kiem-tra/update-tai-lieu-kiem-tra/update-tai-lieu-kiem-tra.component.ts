...
@Component({
  selector: 'app-update-tai-lieu-kiem-tra',
  templateUrl: './update-tai-lieu-kiem-tra.component.html',
  styleUrls: ['./update-tai-lieu-kiem-tra.component.scss']
})
export class UpdateTaiLieuKiemTraComponent implements OnInit {
  @Input() id: number;
