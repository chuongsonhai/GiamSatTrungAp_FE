...
@Component({
  selector: 'app-update-phu-luc-hop-dong',
  templateUrl: './update-phu-luc-hop-dong.component.html',
  styleUrls: ['./update-phu-luc-hop-dong.component.scss']
})
export class UpdatePhuLucHopDongComponent implements OnInit {
