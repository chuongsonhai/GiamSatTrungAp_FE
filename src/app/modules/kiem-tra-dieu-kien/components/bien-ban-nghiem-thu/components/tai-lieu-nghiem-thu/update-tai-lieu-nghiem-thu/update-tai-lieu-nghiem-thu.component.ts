...
@Component({
  selector: 'app-update-tai-lieu-nghiem-thu',
  templateUrl: './update-tai-lieu-nghiem-thu.component.html',
  styleUrls: ['./update-tai-lieu-nghiem-thu.component.scss']
})
export class UpdateTaiLieuNghiemThuComponent implements OnInit {
