...
import { DoingBusinessComponent } from '../../thoa-thuan-dau-noi/doing-business/doing-business.component';
...
@Component({
  selector: 'app-list-yeu-cau',
  templateUrl: './list-yeu-cau.component.html',
  styleUrls: ['./list-yeu-cau.component.scss'],
  providers: [
...
export class ListYeuCauComponent implements
  OnInit,
  OnDestroy,
  IDeleteAction,
  IDeleteSelectedAction,
