...
import { BaoCaoChiTietTCDNQuaHan } from '../models/baocaochitiettcdnquahan.model';

@Injectable({
    providedIn: 'root'
})
export class BaoCaoChiTietTCDNQuaHanService extends TableService<BaoCaoChiTietTCDNQuaHan> implements OnDestroy {
    API_URL = `${environment.apiUrl}/chitiettcdnquahan`;
