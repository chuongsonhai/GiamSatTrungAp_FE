...
import { BaoCaoYCNT } from '../models/baocaoycnt.model';

@Injectable({
    providedIn: 'root'
})
export class BaoCaoYCNTService extends TableService<BaoCaoYCNT> implements OnDestroy {
    API_URL = `${environment.apiUrl}/baocaoycnt`;
