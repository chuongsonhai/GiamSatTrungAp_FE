...
import { KetQuaKS } from '../models/base.model';

@Injectable({
    providedIn: 'root'
})
export class KetQuaKSService extends TableService<KetQuaKS> implements OnDestroy {
    API_URL = `${environment.apiUrl}/ketquaks`;
