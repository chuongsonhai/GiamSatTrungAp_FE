...
import { KetQuaKT } from '../models/ketquakt.model';

@Injectable({
    providedIn: 'root'
})
export class KetQuaKTService extends TableService<KetQuaKT> implements OnDestroy {
    API_URL = `${environment.apiUrl}/ketquakt`;
