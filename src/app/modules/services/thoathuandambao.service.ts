...
import { ThoaThuanDamBao } from '../models/base.model';

@Injectable({
    providedIn: 'root'
})
export class ThoaThuanDamBaoService extends TableService<ThoaThuanDamBao> implements OnDestroy {
    API_URL = `${environment.apiUrl}/thoathuandambao`;
