...
import { ThoaThuanTyLe } from '../models/thoathuantyle.model';


@Injectable({
    providedIn: 'root'
})
export class ThoaThuanTyLeService extends TableService<ThoaThuanTyLe> implements OnDestroy {
    API_URL = `${environment.apiUrl}/thoathuantyle`;
    ...
    public getMDSD(maDonvi:string,maYcau:string){
        const url = `${environment.apiUrl}/thietbi/filter`;
        this._isLoading$.next(true);
        this._errorMessage.next('');
        const body = { maDViQLy: maDonvi, MaYeuCau: maYcau };
