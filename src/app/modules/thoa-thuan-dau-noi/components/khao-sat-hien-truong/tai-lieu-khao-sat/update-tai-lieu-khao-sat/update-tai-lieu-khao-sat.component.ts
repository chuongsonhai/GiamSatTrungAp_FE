...
import { CongVanYeuCau, TaiLieuKS } from 'src/app/modules/models/base.model';
...
@Component({
  selector: 'app-update-tai-lieu-khao-sat',
  templateUrl: './update-tai-lieu-khao-sat.component.html',
  styleUrls: ['./update-tai-lieu-khao-sat.component.scss']
})
export class UpdateTaiLieuKhaoSatComponent implements OnInit {
